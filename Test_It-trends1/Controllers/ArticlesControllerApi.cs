...
namespace Test_It_trends1.Controllers
{
    ...
    public class ArticlesControllerApi : ControllerBase
    {
        Context db;
        public ArticlesControllerApi(Context context) // Тут создаётся контекст и срабатывает конструктор контекста
        {
            db = context;
